...
import FilmFlixNavigationLink from "src/components/FilmFlixNavigationLink";
...
const StyledSlider = styled(Slider)(
  ({ theme, padding }: { theme: Theme; padding: number }) => ({
    ...
    [theme.breakpoints.up("sm")]: {
      ...
      "& .slick-list > .slick-track > .slick-current > div > .FilmFlixBox-root > .FilmFlixPaper-root:hover":
        {
